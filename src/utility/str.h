...
namespace Str {
    ...
    constexpr std::string statement = "statement";
    constexpr std::string subject = "subject";
    constexpr std::string semester = "semester";
    constexpr std::string workNumber = "work_number";
    constexpr std::string start = "start";
    constexpr std::string end = "end";
